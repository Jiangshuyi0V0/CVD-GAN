...
from training.loss_utils import RGBuvHistBlock


def compute_CL(opts, num_gen, batch_size=64, batch_gen=None):
    ...
    res = StyleGAN2Loss.histloss(opts.device, test, test_sim)
